...
import * as testingConstants from '../../constants/tests/routes';
  ...
  return (
    <main className={ `${ styles.content } ${ extraClass }` }>
      ...
      >
        ...
        <Link
          data-test-id={ testingConstants.LINK_STACK_PAGE_TEST_ID }
          className={ styles.link }
          to="/stack"
        >
        ...
        <Link
          data-test-id={ testingConstants.LINK_QUEUE_PAGE_TEST_ID }
          className={ styles.link }
          to="/queue"
        >
        ...
        <Link
          data-test-id={ testingConstants.LINK_LIST_PAGE_TEST_ID }
          className={ styles.link }
          to="/list"
        >
